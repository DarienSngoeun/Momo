      ...
      <div className="relative">
        ...
        >
          ...
          <div className="relative w-full h-full bg-white rounded-[2.5rem] overflow-hidden">
            ...
            {/* Status bar background overlay - prevents content from showing behind status bar */}
            <div className="absolute top-0 left-0 right-0 h-12 bg-white z-40 pointer-events-none" />
